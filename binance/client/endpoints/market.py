...
from binance.enums.binance import ContractType, KlineInterval, Period
...
@endpoints.get("/fapi/v1/historicalTrades", add_api_key=True)
...
def funding_rate_history(
    symbol: str, startTime: Optional[int] = None, endTime: Optional[int] = None, limit: Optional[int] = None
) -> Response:
    """
...
@endpoints.get("/futures/data/topLongShortAccountRatio", add_api_key=True)
