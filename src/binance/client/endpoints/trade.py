...
class Trade(object):
    ...
    async def set_position_mode(self, dual_side_position, timestamp=None, receive_window=None):
        ...
        return await self._client._call(http.Call.POST, '/fapi/v1/positionSide/dual', params=params, sign=True, use_api_key=True)
    ...
    async def get_position_mode(self, timestamp=None, receive_window=None):
        ...
        return await self._client._call(http.Call.GET, '/fapi/v1/positionSide/dual', params=params, sign=True, use_api_key=True)
    ...
    async def new_order(self, order, timestamp=None, receive_window=None):
        ...
        return await self._client._call(http.Call.POST, '/fapi/v1/order', params=params, sign=True, use_api_key=True)
    ...
    async def batch_order(self, orders, timestamp=None, receive_window=None):
        ...
        return await self._client._call(http.Call.POST, '/fapi/v1/batchOrders', params=params, sign=True, use_api_key=True)
