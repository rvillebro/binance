...
class UserDataStreams(Endpoints): ...


@UserDataStreams.add('POST', '/fapi/v1/listenKey', add_api_key=True)
def get_listen_key():
    """
...
@UserDataStreams.add('PUT', '/fapi/v1/listenKey', add_api_key=True)
...
@UserDataStreams.add('DELETE', '/fapi/v1/listenKey', add_api_key=True)
def close_list_key():
    """
